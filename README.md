...
Contribute to HospitalRun using [GitHub Codespace](https://github.com/features/codespaces) a fully featured online development environment that will automatically: clone the repo, install the dependencies and start the webserver.
